describe '#display_rainbow' do
  it 'accepts one argument' do
    ...
    expect { display_rainbow(['red', 'orange', 'yellow', 'green', 'blue', 'indigo', 'violet']) }.to_not raise_error(NoMethodError)
    expect { display_rainbow(['red', 'orange', 'yellow', 'green', 'blue', 'indigo', 'violet']) }.to_not raise_error(ArgumentError)
  end
